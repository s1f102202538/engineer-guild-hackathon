...
const HomePage: React.FC = () => {
  ...
  // 1週間分の日別カロリー（例：7日分）
  const dailyCaloriesData = [100, 150, 200, 250, 300, 350, 400,150, 200, 250, 300, 350, 400, 150, 200, 250,300,150, 200, 250, 300, 350, 300,150, 200, 250, 300, 350, 400, 350, 400,300,150, 200, 250, 300, 350];
  // 半年分の週間ごとのカロリー（例：26週分）
  const weeklyCaloriesData = [100, 150, 200, 250, 300, 350, 400,150, 200, 250, 300, 350, 400, 150, 200, 250,300,150, 200, 250, 300, 350, 300,150, 200, 250, 300, 350, 400, 350, 400,300,150, 200,]
